...
import { classnames, debounce } from '@bpm/utils';
...
import svgArrowT0 from '@/../static/images/arrow-t-0.svg';
import svgArrowT1 from '@/../static/images/arrow-t-1.svg';
import svgArrowR0 from '@/../static/images/arrow-r-0.svg';
import svgArrowR1 from '@/../static/images/arrow-r-1.svg';
...
export const FlowChart: React.FunctionComponent<
  IProps & {
      ...
      <div className={`${cls}-b`}>
        ...
        <div className={`${cls}-b-r`}>
          ...
          <div className={`${cls}-b-r-r`}>
            {render.sidebar && render.sidebar(selectedCells, editorUI)}
          </div>
        </div>
      </div>
    </div>
