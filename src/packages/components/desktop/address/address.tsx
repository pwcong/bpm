...
import { ICommonPropertyProps } from '@/packages/components/types';
import { ISelectorRefObject } from '@/packages/components/desktop/input-select';
...
const baseCls = 'bpm-cmpt-address';
