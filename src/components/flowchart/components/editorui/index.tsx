...
import { EEventName, IConfig, ECellKey, IBaseConfig, ICell } from '../../types'
            ...
            <ArrowPanel 
              ...
              data={connections.map(c => ({
                ...
                getComponent: c.getComponent ? (
                  cmpt: React.ReactElement,
                  ui: EditorUI,
                  item: ICell
                ) => (
                  c.getComponent ? React.cloneElement(c.getComponent(cmpt, ui, item), {
                    onClick: () => {
